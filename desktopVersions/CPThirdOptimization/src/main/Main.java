...
public class Main {
	...
	private static final String CSV_FILE_NAME = "newOptimization3RandomConfs.csv";
	...
	private static void renameFilesAccordingToCrescentOrder(String directoryPathName) {
		...
		if (dir.isDirectory()) // make sure it's a directory
			for (final File f : dir.listFiles()) {
				try {
					filesCounter++;
					File newfile = new File(ROOT_NAME_REAL_CONF + filesCounter + FORMAT);
