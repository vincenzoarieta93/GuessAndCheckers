...
versionWithMyPawns(V) :- numMyPawns(V,N), N<>0.
versionWithoutMyPawns(V) :- not versionWithMyPawns(V), choose(V).
numMyPawns(V,0) :- versionWithoutMyPawns(V).

versionWithEnemyPawns(V) :- numEnemyPawns(V,N), N<>0.
versionWithoutEnemyPawns(V) :- not versionWithEnemyPawns(V), choose(V).
numEnemyPawns(V,0) :- versionWithoutEnemyPawns(V).
