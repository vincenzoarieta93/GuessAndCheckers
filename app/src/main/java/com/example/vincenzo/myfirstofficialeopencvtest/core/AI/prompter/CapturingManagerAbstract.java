...
import com.example.vincenzo.myfirstofficialeopencvtest.core.ai.prompter.base.AbstractASPManagerDumb;
...
public class CapturingManagerAbstract extends AbstractASPManagerDumb {
    ...
    public CapturingManagerAbstract(Context context, ChessboardImpl chessboardImpl, PawnsColor color) {
    ...
    public void solve() {
        ...
        if (jumpingPawns.size() > 0) {
            ...
            ChooserCapturingManagerAbstract chooser = new ChooserCapturingManagerAbstract(chessboard, context, jumpingPawns, jumps);
            chooser.solve();
